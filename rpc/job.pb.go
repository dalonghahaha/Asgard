...
var fileDescriptor_f32c477d91a04ead = []byte{
	...
	,
}
...
type CronClient interface {
	...
	Get(ctx context.Context, in *Name, opts ...grpc.CallOption) (*JobResponse, error)
...
func (c *cronClient) Get(ctx context.Context, in *Name, opts ...grpc.CallOption) (*JobResponse, error) {
	out := new(JobResponse)
...
func (c *cronClient) Remove(ctx context.Context, in *Name, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
type CronServer interface {
	...
	Get(context.Context, *Name) (*JobResponse, error)
...
func (*UnimplementedCronServer) Get(ctx context.Context, req *Name) (*JobResponse, error) {
...
func (*UnimplementedCronServer) Remove(ctx context.Context, req *Name) (*Response, error) {
...
func _Cron_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CronServer).Get(ctx, req.(*Name))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Cron_Remove_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CronServer).Remove(ctx, req.(*Name))
	}
	return interceptor(ctx, in, info, handler)
}
